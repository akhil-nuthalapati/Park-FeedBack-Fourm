...
/**
 * Submit feedback for a park (anonymous).
 */
...
/**
 * Get all feedback for a specific park (authenticated only).
 */
...
/**
 * Get all feedback (authenticated, for dashboard).
 */
...
/**
 * Get average ratings (optionally by park).
 */
